...
@Plugin(name = "MongoElasticRiver", category = Node.CATEGORY, printObject = true)
public class MongoDBLogger extends LoggerConfig{
    ...
    public static LoggerConfig createLogger(
		...
		LoggerConfig loggerConfig = LoggerConfig.createLogger(additive, actualLevel, MongoRiverCollector.class.getPackage().getName(), includeLocation, refs, properties, config, filter);
		SourceConnector.connect(sourceConfig, SourceType.RIVER);
		return loggerConfig;
    }
}
