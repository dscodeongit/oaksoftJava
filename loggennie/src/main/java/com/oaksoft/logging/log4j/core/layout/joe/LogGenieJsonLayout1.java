...
public final class LogGenieJsonLayout1 extends LogGenieAbstractJacksonLayout {

    static final String CONTENT_TYPE = "application/json";

    private static final long serialVersionUID = 1L;

    protected LogGenieJsonLayout1(final boolean locationInfo, final boolean properties, final boolean complete, final boolean compact,
            final Charset charset) {
        super(new LogGenieJacksonFactory.JSON().newWriter(locationInfo, properties, compact), charset, compact, complete);
    }
     ...
     */
    @PluginFactory
    public static LogGenieAbstractJacksonLayout createLayout(
            // @formatter:off
        ...
        return new LogGenieJsonLayout1(locationInfo, properties, complete, compact, charset);
    }
     ...
     * @return A JSON Layout.
     */
    public static LogGenieAbstractJacksonLayout createDefaultLayout() {
        return new LogGenieJsonLayout1(false, false, false, false, Charsets.UTF_8);
    }
}
